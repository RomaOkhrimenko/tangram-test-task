...
import ChatMembers from '@/modules/chat/components/messages/messages-header/ChatMembers.vue'
import ChatSettings from '@/modules/chat/components/messages/messages-header/ChatSettings.vue'
import ModalWrapper from '@/modules/chat/components/modals/ModalWrapper.vue'
import ChatInfo from '@/modules/chat/components/chat-info/ChatInfoModal.vue'
...
export default {
  ...
  methods: {
    ...
    checkClickMore(e) {
      if (!e.target.closest('.messages-header-settings')) {
